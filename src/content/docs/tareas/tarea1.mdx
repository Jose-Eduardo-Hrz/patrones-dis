...
![Diagrama de Clases](/potrones-dis/tareas/tarea1/diagrama.png)

:::note[Nota]
En la liga [Tarea1. Generar Homoclave](/potrones-dis/tareas/tarea1/GeneradorRFC.rar) podras descargar el proyecto completo.
:::
